...
namespace DigitalWallets.Infra.Data.Migrations
{
    ...
    [Migration("20250517001457_AddWalletTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalWallets.Domain.Account.AuthUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DigitalWallets.Domain.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DigitalWallets.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("DigitalWallets.Domain.Account.AuthUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalWallets.Domain.Account.AuthUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("DigitalWallets.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasOne("DigitalWallets.Domain.Account.AuthUser", "User")
                        .WithMany()
